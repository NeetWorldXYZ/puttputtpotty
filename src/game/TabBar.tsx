...
function NavIcon({ tab }: { tab: Tab }) {
  const art = {
    ...
    match: <><path d="m11 5 25 30m1-30L12 35" stroke="#ffe0a0" strokeWidth="6"/><path d="m11 5 25 30m1-30L12 35" stroke="#a86b43" strokeWidth="2"/><path d="m28 28 13 11-5 6-17-15Z" fill="#fa7e68"/><path d="m20 28-13 11 5 6 17-15Z" fill="#64c8db"/><path d="m5 41 5 5m33-5-5 5" stroke="#fff0cc" strokeWidth="2"/></>,
