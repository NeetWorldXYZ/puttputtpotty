...
export function MatchDailyCard({ disabled }: { disabled: boolean }) {
  ...
  return <section data-scene-pending={!result} className={`md-card${played ? ' md-played' : ''}`} aria-labelledby="md-title">
    <DailyEmblem/>
