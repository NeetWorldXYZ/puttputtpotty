...
import { getAudio, isMuted, setMuted, unlockAudio } from './sound';
...
export function MenuVolume() {
  ...
  return <button className="menu-volume" aria-label={muted ? 'Turn sound on' : 'Mute sound'} aria-pressed={muted} onClick={() => { unlockAudio(); setMuted(!isMuted()); }}>
