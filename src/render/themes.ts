...
export const THEMES: Theme[] = [
  {
    ...
    surround: '#2f4a33',
    surroundB: '#294029',
    floor: { kind: 'tile', a: '#7fb07a', b: '#6a9a66', grout: '#3e5a3c' },
    pipe: { fill: '#c47a3a', highlight: '#f0b070', shade: '#8a4f22', style: 'bands' },
    accent: '#ffd166',
    props: ['stain', 'bolt', 'mopBucket', 'wrench', 'outOfOrder'],
    propDensity: 0.9,
    decals: ['stain', 'scuff'],
    decalDensity: 0.6,
  },
  {
    ...
    surround: '#d9cfc0',
    surroundB: '#cbbfae',
    floor: { kind: 'marble', a: '#f6f1e8', b: '#e6dccb', grout: '#c9bca6' },
    pipe: { fill: '#f0c04a', highlight: '#fff0a8', shade: '#b8861b', style: 'gold' },
    accent: '#f0c04a',
    props: ['towel', 'orchid', 'goldTap', 'doily'],
    propDensity: 0.6,
    decals: ['sparkle'],
    decalDensity: 0.2,
  },
  {
    ...
    surround: '#2a2036',
    surroundB: '#221a2e',
    floor: { kind: 'checker', a: '#4a3a5c', b: '#33273f', grout: '#1f1828' },
  ...
  },
  {
    ...
    surround: '#a9b4bf',
    surroundB: '#9ba6b1',
    floor: { kind: 'terrazzo', a: '#dfe4e8', b: '#c7ced4', grout: '#b3bcc4' },
    pipe: { fill: '#a8b8c6', highlight: '#e6eef4', shade: '#6f7f8c', style: 'chrome' },
    accent: '#3a86ff',
    props: ['stallDoor', 'suitcase', 'gateSign', 'stallDoor'],
    propDensity: 0.8,
    decals: ['scuff'],
    decalDensity: 0.2,
  },
  {
    ...
    surround: '#3d6a9a',
    surroundB: '#345d88',
    floor: { kind: 'plastic', a: '#4f95d4', b: '#3f80bb', grout: '#2c5a86' },
  ...
  },
  {
    ...
    surround: '#6b6a72',
    surroundB: '#5c5b64',
    floor: { kind: 'cobble', a: '#a9a5a0', b: '#8f8a85', grout: '#5e5a56' },
  ...
  },
  {
    ...
    surround: '#0d1430',
    surroundB: '#0a1028',
    floor: { kind: 'metalGrid', a: '#4b5d86', b: '#3c4c70', grout: '#7fd6ff' },
  ...
  },
  {
    ...
    surround: '#2a2438',
    surroundB: '#231e30',
    floor: { kind: 'crackedTile', a: '#7b7590', b: '#68627c', grout: '#3d3850' },
  ...
  },
  {
    ...
    surround: '#2f8f5b',
    surroundB: '#27804f',
    floor: { kind: 'bamboo', a: '#e6bc73', b: '#d6a95f', grout: '#a67a3a' },
  ...
  },
  {
    ...
    surround: '#b8bec6',
    surroundB: '#aab1b9',
    floor: { kind: 'bigTile', a: '#dde2e7', b: '#d2d8de', grout: '#f5f7f9' },
    pipe: { fill: '#eef2f5', highlight: '#ffffff', shade: '#aab4bd', style: 'plain' },
    accent: '#5be3a3',
    props: ['washSign', 'dispenser', 'sensor', 'dispenser'],
    propDensity: 0.6,
    decals: [],
    decalDensity: 0,
  },
  {
    ...
    surround: '#d8a9b8',
    surroundB: '#cc9dad',
    floor: { kind: 'floralCarpet', a: '#f2d7de', b: '#e9c1cc', grout: '#d99aa9' },
  ...
  },
  {
    ...
    surround: '#2c6a3c',
    surroundB: '#255c34',
    floor: { kind: 'stripes', a: '#3fae5c', b: '#36994f', grout: '#f1f1f1' },
    pipe: { fill: '#9fb0bd', highlight: '#e4ecf2', shade: '#5e6e7c', style: 'chrome' },
    accent: '#ffd166',
    props: ['crowd', 'pennant', 'foamFinger', 'sinkPuddle'],
    propDensity: 0.9,
