...
export const THEMES: Theme[] = [
  {
    ...
    accent: '#ffd166',
    props: ['sink', 'brush', 'mopBucket', 'soap', 'paperStack'],
    propDensity: 0.9,
    decals: ['stain', 'scuff'],
    decalDensity: 0.6,
  },
  {
    ...
    accent: '#f0c04a',
    props: ['sink', 'towel', 'palm', 'soap', 'towel'],
    propDensity: 0.6,
    decals: ['sparkle'],
    decalDensity: 0.2,
  },
  {
    ...
    accent: '#ff3fa4',
    props: ['sink', 'brush', 'soap', 'paperStack', 'mopBucket'],
    propDensity: 1.0,
  ...
  },
  {
    ...
    accent: '#3a86ff',
    props: ['sink', 'suitcase', 'suitcase', 'soap', 'paperStack'],
    propDensity: 0.8,
    decals: ['scuff'],
    decalDensity: 0.2,
  },
  {
    ...
    accent: '#ffd60a',
    props: ['brush', 'mopBucket', 'soap', 'paperStack'],
    propDensity: 0.8,
    decals: ['scuff', 'stain'],
    decalDensity: 0.4,
  },
  {
    ...
    accent: '#e0a458',
    props: ['sink', 'towel', 'brush', 'paperStack'],
    propDensity: 0.7,
    decals: ['crack'],
    decalDensity: 0.4,
  },
  {
    ...
    accent: '#7fd6ff',
    props: ['sink', 'soap', 'brush', 'paperStack'],
    propDensity: 1.2,
    decals: ['sparkle'],
    decalDensity: 0.3,
  },
  {
    ...
    accent: '#b388ff',
    props: ['sink', 'brush', 'towel', 'paperStack'],
    propDensity: 0.8,
    decals: ['crack'],
    decalDensity: 0.6,
  },
  {
    ...
    accent: '#ff7f50',
    props: ['palm', 'palm', 'towel', 'soap', 'sink'],
    propDensity: 0.9,
    decals: ['leaf', 'petal'],
    decalDensity: 0.5,
  },
  ...
  },
  {
    ...
    accent: '#f28cae',
    props: ['towel', 'soap', 'palm', 'paperStack'],
    propDensity: 0.7,
    decals: ['petal'],
    decalDensity: 0.5,
  },
